...
\item \textbf{Interprétation:} la stratégie de vision n$\textsuperscript{o}$5 fournit au serpent des informations plus pertinents pour localiser la pomme et anticiper ses mouvements sans se retrouver prisonier de ses mouvements.
\end{itemize}
