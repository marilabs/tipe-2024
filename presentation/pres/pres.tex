...
\small
\textbf{Origines:} borne d'arcade \textit{Blockade}, créée par Gremlin en 1976, popularisé par Nokia en 1997 sur mobile $\rightarrow$ jeu culte
...
\end{itemize}
\vspace{-1cm}\hspace{-0.2cm}
\begin{figure}
\centering
\includegraphics[width=0.35\textwidth]{snake_nokia.png}
\end{figure}
