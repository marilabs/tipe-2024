...
%  \readlist\Nnod{4,3,2} % array of number of nodes per layer
  ...
  \pgfmathsetmacro\maxN{max(\Nnod)} % find the maximum number of nodes in any layer
  ...
  \node[above=2,align=center,mydarkblue] at (N3-1.90) {Hidden\\[-0.2em]layers};
